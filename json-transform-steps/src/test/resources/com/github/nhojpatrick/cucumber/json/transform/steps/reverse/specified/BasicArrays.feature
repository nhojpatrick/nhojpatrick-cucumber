...
@Transformation
@Remove
Feature: Transformation - Reverse - Checking BasicArrays with Specified keys
  ...
  Scenario Outline: Remove Specified Keys, Basic Arrays, Paths Attributes success
    ...
    Examples:
      | path             | expected                                                                                                                                                                                                                                                                                                                        |
      | objects_array    | {objects_array=[{object_array_id=dObjectArrayId}, {object_array_id=cObjectArrayId}, {object_array_id=bObjectArrayId}, {object_array_id=aObjectArrayId}], objects_empty=[], objects_null=null, primitives_array=[aPrimitiveArray, bPrimitiveArray, cPrimitiveArray, dPrimitiveArray], primitives_empty=[], primitives_null=null} |
      | objects_empty    | {objects_array=[{object_array_id=aObjectArrayId}, {object_array_id=bObjectArrayId}, {object_array_id=cObjectArrayId}, {object_array_id=dObjectArrayId}], objects_empty=[], objects_null=null, primitives_array=[aPrimitiveArray, bPrimitiveArray, cPrimitiveArray, dPrimitiveArray], primitives_empty=[], primitives_null=null} |
      | primitives_array | {objects_array=[{object_array_id=aObjectArrayId}, {object_array_id=bObjectArrayId}, {object_array_id=cObjectArrayId}, {object_array_id=dObjectArrayId}], objects_empty=[], objects_null=null, primitives_array=[dPrimitiveArray, cPrimitiveArray, bPrimitiveArray, aPrimitiveArray], primitives_empty=[], primitives_null=null} |
      | primitives_empty | {objects_array=[{object_array_id=aObjectArrayId}, {object_array_id=bObjectArrayId}, {object_array_id=cObjectArrayId}, {object_array_id=dObjectArrayId}], objects_empty=[], objects_null=null, primitives_array=[aPrimitiveArray, bPrimitiveArray, cPrimitiveArray, dPrimitiveArray], primitives_empty=[], primitives_null=null} |
  ...
  Scenario Outline: Remove Specified Keys, Basic Arrays, Paths Attributes errors
    ...
    Examples:
      | path            | error                                                      |
      | objects_null    | Unable to reverse 'null' value, at path 'objects_null'.    |
      | primitives_null | Unable to reverse 'null' value, at path 'primitives_null'. |
  ...
  Scenario Outline: Remove Specified Keys, Basic Arrays, Paths Arrays errors
    ...
    Examples:
      | path                | error                                                              |
      | objects_array[0]    | Unable to reverse JsonObject, at path 'objects_array[0]'.          |
      | objects_array[1]    | Unable to reverse JsonObject, at path 'objects_array[1]'.          |
      | objects_array[2]    | Unable to reverse JsonObject, at path 'objects_array[2]'.          |
      | objects_array[3]    | Unable to reverse JsonObject, at path 'objects_array[3]'.          |
      | objects_array[4]    | Unable to reverse path 'objects_array[4]', beyond index of '3'.    |
      | objects_empty[0]    | Unable to reverse path 'objects_empty', as array is empty.         |
      | objects_null[0]     | Unable to reverse 'null' value, at path 'objects_null'.            |
      | primitives_array[4] | Unable to reverse path 'primitives_array[4]', beyond index of '3'. |
      | primitives_empty[0] | Unable to reverse path 'primitives_empty', as array is empty.      |
      | primitives_null[0]  | Unable to reverse 'null' value, at path 'primitives_null'.         |
  ...
  Scenario Outline: Remove Specified Keys, Basic Arrays, Paths Objects success
    ...
    Examples:
      | path                             | expected                                                                                                                                                                                                                                                                                                                        |
      | objects_array[0].object_array_id | {objects_array=[{object_array_id=dIyarrAtcejbOa}, {object_array_id=bObjectArrayId}, {object_array_id=cObjectArrayId}, {object_array_id=dObjectArrayId}], objects_empty=[], objects_null=null, primitives_array=[aPrimitiveArray, bPrimitiveArray, cPrimitiveArray, dPrimitiveArray], primitives_empty=[], primitives_null=null} |
      | objects_array[1].object_array_id | {objects_array=[{object_array_id=aObjectArrayId}, {object_array_id=dIyarrAtcejbOb}, {object_array_id=cObjectArrayId}, {object_array_id=dObjectArrayId}], objects_empty=[], objects_null=null, primitives_array=[aPrimitiveArray, bPrimitiveArray, cPrimitiveArray, dPrimitiveArray], primitives_empty=[], primitives_null=null} |
      | objects_array[2].object_array_id | {objects_array=[{object_array_id=aObjectArrayId}, {object_array_id=bObjectArrayId}, {object_array_id=dIyarrAtcejbOc}, {object_array_id=dObjectArrayId}], objects_empty=[], objects_null=null, primitives_array=[aPrimitiveArray, bPrimitiveArray, cPrimitiveArray, dPrimitiveArray], primitives_empty=[], primitives_null=null} |
      | objects_array[3].object_array_id | {objects_array=[{object_array_id=aObjectArrayId}, {object_array_id=bObjectArrayId}, {object_array_id=cObjectArrayId}, {object_array_id=dIyarrAtcejbOd}], objects_empty=[], objects_null=null, primitives_array=[aPrimitiveArray, bPrimitiveArray, cPrimitiveArray, dPrimitiveArray], primitives_empty=[], primitives_null=null} |
