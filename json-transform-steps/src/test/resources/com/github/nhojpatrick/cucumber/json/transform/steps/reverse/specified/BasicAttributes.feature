...
@Transformation
@Remove
Feature: Transformation - Reverse - Checking BasicAttributes with Specified keys
  ...
  Scenario Outline: Remove Specified Keys, Basic Arrays, Paths Attributes success
    ...
    Examples:
      | path      | expected                                                                                         |
      | a_boolean | {a_boolean=eurt, a_float=12.34, a_integer=1234, a_null=null, a_object_empty={}, a_string=aValue} |
      | a_float   | {a_boolean=true, a_float=43.21, a_integer=1234, a_null=null, a_object_empty={}, a_string=aValue} |
      | a_integer | {a_boolean=true, a_float=12.34, a_integer=4321, a_null=null, a_object_empty={}, a_string=aValue} |
      | a_string  | {a_boolean=true, a_float=12.34, a_integer=1234, a_null=null, a_object_empty={}, a_string=eulaVa} |
  ...
  Scenario Outline: Remove Specified Keys, Basic Arrays, Paths Attributes errors
    ...
    Examples:
      | path           | error                                                   |
      | a_null         | Unable to reverse 'null' value, at path 'a_null'.       |
      | a_object_empty | Unable to reverse JsonObject, at path 'a_object_empty'. |
  ...
  Scenario Outline: Remove Specified Keys, Basic Arrays, Paths Arrays errors
    ...
    Examples:
      | path              | error                                                     |
      | a_boolean[0]      | Unable to reverse path 'a_boolean', as is not Array.      |
      | a_float[0]        | Unable to reverse path 'a_float', as is not Array.        |
      | a_integer[0]      | Unable to reverse path 'a_integer', as is not Array.      |
      | a_null[0]         | Unable to reverse 'null' value, at path 'a_null'.         |
      | a_object_empty[0] | Unable to reverse path 'a_object_empty', as is not Array. |
      | a_string[0]       | Unable to reverse path 'a_string', as is not Array.       |
