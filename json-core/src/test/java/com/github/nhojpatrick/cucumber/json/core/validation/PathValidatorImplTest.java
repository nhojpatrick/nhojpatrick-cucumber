    ...
    public Collection<DynamicTest> invalidPaths() {
        ...
        return Arrays.asList(
                ...
                DynamicTest.dynamicTest("path - Null", () -> {
                    ...
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path is Null.")));
                }),

                DynamicTest.dynamicTest("path - Empty String", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path is Empty.")));
                }),

                DynamicTest.dynamicTest("path - Whitespace String", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("          ");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path is Whitespace only '          '.")));
                }),

                DynamicTest.dynamicTest("path - Whitespace Leading", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("          path");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path has Leading or Trailing Whitespace '          path'.")));
                }),
                ...
                DynamicTest.dynamicTest("path - Whitespace Within", () -> {
                    ...
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path contains Whitespace 'start end'.")));
                }),

                DynamicTest.dynamicTest("path - Dot Leading", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath(".path");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path has Leading or Trailing Dot '.path'.")));
                }),
                ...
                DynamicTest.dynamicTest("path - Double Dots", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("start..end");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path has Sequential Dots 'start..end'.")));
                }),
    ...
    public Collection<DynamicTest> invalidSplits() {
        ...
        return Arrays.asList(
                ...
                DynamicTest.dynamicTest("split - [ Missing (path))", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("]");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path ']' Split has missing [ ']'.")));
                }),

                DynamicTest.dynamicTest("split - [ Missing (path.split))", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("abc.]");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path 'abc.]' Split has missing [ ']'.")));
                }),
                ...
                DynamicTest.dynamicTest("split - [] Empty (path)", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("a[]");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path 'a[]' Split has invalid index [] 'a[]'.")));
                }),

                DynamicTest.dynamicTest("split - [] Empty (path.split)", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("abc.d[]");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path 'abc.d[]' Split has invalid index [] 'd[]'.")));
                }),

                DynamicTest.dynamicTest("split - [] Alpha (path)", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("a[bc]");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path 'a[bc]' Split has invalid index [] 'a[bc]'.")));
                }),

                DynamicTest.dynamicTest("split - [] Alpha (path.split)", () -> {
                    final Executable testMethod = () -> classUnderTest.parsePath("abc.d[ef]");
                    final InvalidPathException expectedThrown = assertThrows(InvalidPathException.class, testMethod);
                    assertThat(expectedThrown.getMessage(), is(equalTo("Path 'abc.d[ef]' Split has invalid index [] 'd[ef]'.")));
                })
