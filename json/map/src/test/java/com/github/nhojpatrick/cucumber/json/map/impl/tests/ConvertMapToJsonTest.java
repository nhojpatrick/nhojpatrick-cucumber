        ...
        return Arrays.asList(
                ...
                dynamicTest("JsonProcessingException", () -> {
                    ...
                    assertAll("Checking Exception",
                            () -> assertThat(thrown.getMessage(), is(equalTo("com.fasterxml.jackson.databind.exc.InvalidDefinitionException: No serializer found for class com.github.nhojpatrick.cucumber.json.map.impl.tests.ConvertMapToJsonTest$ClassThatJacksonCannotSerialize and no properties discovered to create BeanSerializer (to avoid exception, disable SerializationFeature.FAIL_ON_EMPTY_BEANS) (through reference chain: java.util.TreeMap[\"issue\"])"))),
