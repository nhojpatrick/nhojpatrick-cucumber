...
public class MySimpleObj
    ...
    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code MySimpleObj}.
     * @return the meta-bean, not null
     */
    public static MySimpleObj.Meta meta() {
        return MySimpleObj.Meta.INSTANCE;
    }

    static {
        MetaBean.register(MySimpleObj.Meta.INSTANCE);
    }

    @Override
    public MySimpleObj.Meta metaBean() {
        return MySimpleObj.Meta.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            MySimpleObj other = (MySimpleObj) obj;
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<String> simpleName = DirectMetaProperty.ofReadOnly(
                this, "simpleName", MySimpleObj.class, String.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends MySimpleObj> builder() {
            return new DirectBeanBuilder<>(new MySimpleObj());
        }

        @Override
        public Class<? extends MySimpleObj> beanType() {
            return MySimpleObj.class;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case -1431767203:  // simpleName
                    return ((MySimpleObj) bean).getSimpleName();
            }
