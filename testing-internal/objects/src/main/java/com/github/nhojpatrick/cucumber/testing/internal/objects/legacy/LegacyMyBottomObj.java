...
public class LegacyMyBottomObj
    ...
    public LegacyMyBottomObj(final String alpha) {
        this.alpha = alpha;
    }

    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code LegacyMyBottomObj}.
     * @return the meta-bean, not null
     */
    public static LegacyMyBottomObj.Meta meta() {
        return LegacyMyBottomObj.Meta.INSTANCE;
    }

    static {
        MetaBean.register(LegacyMyBottomObj.Meta.INSTANCE);
    }

    @Override
    public LegacyMyBottomObj.Meta metaBean() {
        return LegacyMyBottomObj.Meta.INSTANCE;
    }
    ...
    //-----------------------------------------------------------------------
    @Override
    public LegacyMyBottomObj clone() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            LegacyMyBottomObj other = (LegacyMyBottomObj) obj;
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<String> alpha = DirectMetaProperty.ofReadOnly(
                this, "alpha", LegacyMyBottomObj.class, String.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends LegacyMyBottomObj> builder() {
            return new DirectBeanBuilder<>(new LegacyMyBottomObj());
        }

        @Override
        public Class<? extends LegacyMyBottomObj> beanType() {
            return LegacyMyBottomObj.class;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 92909918:  // alpha
                    return ((LegacyMyBottomObj) bean).getAlpha();
            }
