...
public class Legacy2BasicAttributesOuterObj
        implements Bean,
        Cloneable {
    ...
    public static final String A_OBJECT = "a_object";
    ...
    @JsonProperty(A_OBJECT)
    @PropertyDefinition(set = "")
    private final Legacy2BasicAttributesInnerObj aObject;

    @JsonProperty(A_STRING)
    @PropertyDefinition(set = "")
    private final String aString;

    Legacy2BasicAttributesOuterObj() {
        this.aBoolean = null;
        this.aFloat = null;
        this.aInteger = null;
        this.aNull = null;
    ...
    public Legacy2BasicAttributesOuterObj(final Boolean aBoolean,
                                          final Float aFloat,
        ...
        this.aNull = null;
        this.aObject = new Legacy2BasicAttributesInnerObj();
        this.aString = aString;
    }

    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code Legacy2BasicAttributesOuterObj}.
     * @return the meta-bean, not null
     */
    public static Legacy2BasicAttributesOuterObj.Meta meta() {
        return Legacy2BasicAttributesOuterObj.Meta.INSTANCE;
    }

    static {
        MetaBean.register(Legacy2BasicAttributesOuterObj.Meta.INSTANCE);
    }

    @Override
    public Legacy2BasicAttributesOuterObj.Meta metaBean() {
        return Legacy2BasicAttributesOuterObj.Meta.INSTANCE;
    }
     ...
     * @return the value of the property
     */
    public Legacy2BasicAttributesInnerObj getAObject() {
        return aObject;
    }

    /**
     * Gets the the {@code aObject} property.
     * @return the property, not null
     */
    public final Property<Legacy2BasicAttributesInnerObj> aObject() {
        return metaBean().aObject().createProperty(this);
    }
    ...
    //-----------------------------------------------------------------------
    @Override
    public Legacy2BasicAttributesOuterObj clone() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            Legacy2BasicAttributesOuterObj other = (Legacy2BasicAttributesOuterObj) obj;
            return JodaBeanUtils.equal(getABoolean(), other.getABoolean()) &&
                    ...
                    JodaBeanUtils.equal(getAObject(), other.getAObject()) &&
    ...
    public int hashCode() {
        ...
        hash = hash * 31 + JodaBeanUtils.hashCode(getAObject());
    ...
    public String toString() {
        ...
        buf.append("Legacy2BasicAttributesOuterObj{");
        int len = buf.length();
        toString(buf);
        if (buf.length() > len) {
    ...
    protected void toString(StringBuilder buf) {
        ...
        buf.append("aObject").append('=').append(JodaBeanUtils.toString(getAObject())).append(',').append(' ');
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<Boolean> aBoolean = DirectMetaProperty.ofReadOnly(
                this, "aBoolean", Legacy2BasicAttributesOuterObj.class, Boolean.class);
        /**
         * The meta-property for the {@code aFloat} property.
         */
        private final MetaProperty<Float> aFloat = DirectMetaProperty.ofReadOnly(
                this, "aFloat", Legacy2BasicAttributesOuterObj.class, Float.class);
        /**
        ...
        private final MetaProperty<Integer> aInteger = DirectMetaProperty.ofReadOnly(
                this, "aInteger", Legacy2BasicAttributesOuterObj.class, Integer.class);
        /**
         * The meta-property for the {@code aNull} property.
         */
        private final MetaProperty<Object> aNull = DirectMetaProperty.ofReadOnly(
                this, "aNull", Legacy2BasicAttributesOuterObj.class, Object.class);
        /**
         * The meta-property for the {@code aObject} property.
         */
        private final MetaProperty<Legacy2BasicAttributesInnerObj> aObject = DirectMetaProperty.ofReadOnly(
                this, "aObject", Legacy2BasicAttributesOuterObj.class,
                Legacy2BasicAttributesInnerObj.class);
        /**
         * The meta-property for the {@code aString} property.
         */
        private final MetaProperty<String> aString = DirectMetaProperty.ofReadOnly(
                this, "aString", Legacy2BasicAttributesOuterObj.class, String.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends Legacy2BasicAttributesOuterObj> builder() {
            return new DirectBeanBuilder<>(new Legacy2BasicAttributesOuterObj());
        }

        @Override
        public Class<? extends Legacy2BasicAttributesOuterObj> beanType() {
            return Legacy2BasicAttributesOuterObj.class;
        }
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<Legacy2BasicAttributesInnerObj> aObject() {
            return aObject;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case -1016724345:  // aBoolean
                    return ((Legacy2BasicAttributesOuterObj) bean).getABoolean();
                case -1449965957:  // aFloat
                    return ((Legacy2BasicAttributesOuterObj) bean).getAFloat();
                case 876616093:  // aInteger
                    return ((Legacy2BasicAttributesOuterObj) bean).getAInteger();
                case 92021128:  // aNull
                    return ((Legacy2BasicAttributesOuterObj) bean).getANull();
                case -1750990080:  // aObject
                    return ((Legacy2BasicAttributesOuterObj) bean).getAObject();
                case -1619607598:  // aString
                    return ((Legacy2BasicAttributesOuterObj) bean).getAString();
            }
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -1750990080:  // aObject
                    ...
                    throw new UnsupportedOperationException("Property cannot be written: aObject");
                case -1619607598:  // aString
                    if (quiet) {
                        return;
                    }
