...
import static com.github.nhojpatrick.cucumber.testing.internal.objects.legacy.LegacyTestingInternalObjectsConstants.LEGACY_COMPLEX_OBJECT_AS_JSON_MAP;
...
import static com.github.nhojpatrick.cucumber.testing.internal.objects.legacy.LegacyTestingInternalObjectsConstants.LEGACY_SIMPLE_OBJECT_AS_JSON_MAP;
...
public class LegacyTestingInternalObjectsConstantsTest {
    ...
    public void complex()
        ...
        final String mapBasicArraysAsStr = new ObjectMapper()
                .writeValueAsString(LEGACY_COMPLEX_OBJECT_AS_OBJECT);

        final String objectBasicArraysAsStr = new ObjectMapper()
                .configure(SerializationFeature.ORDER_MAP_ENTRIES_BY_KEYS, true)
                .writeValueAsString(LEGACY_COMPLEX_OBJECT_AS_JSON_MAP);
    ...
    public void simple()
        ...
        final String mapBasicArraysAsStr = new ObjectMapper()
                .writeValueAsString(LEGACY_SIMPLE_OBJECT_AS_OBJECT);

        final String objectBasicArraysAsStr = new ObjectMapper()
                .configure(SerializationFeature.ORDER_MAP_ENTRIES_BY_KEYS, true)
                .writeValueAsString(LEGACY_SIMPLE_OBJECT_AS_JSON_MAP);
