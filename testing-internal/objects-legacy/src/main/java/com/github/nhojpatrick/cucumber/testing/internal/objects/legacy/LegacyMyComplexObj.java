...
@JsonPropertyOrder({
        LegacyMyComplexObj.ACTIVE,
        LegacyMyComplexObj.COUNT,
        LegacyMyComplexObj.NESTED,
        LegacyMyComplexObj.OBJS,
        LegacyMyComplexObj.TAGS,
        LegacyMyComplexObj.TITLE
})
@SuppressFBWarnings(value = "CN_IDIOM_NO_SUPER_CALL", justification = "Managed by JodaBeans")
@SuppressWarnings("PMD.UselessParentheses")
public class LegacyMyComplexObj
        implements Bean,
        Cloneable {
    ...
    @JsonProperty(NESTED)
    @PropertyDefinition(set = "")
    private final LegacyMyNestedObj nested;

    @JsonProperty(OBJS)
    @PropertyDefinition(set = "")
    private final List<LegacyMyListComplexObj> objs;
    ...
    public LegacyMyComplexObj(final String title,
                              final boolean active,
                              final int count,
                              final List<String> tags,
                              final LegacyMyNestedObj nested,
                              final List<LegacyMyListComplexObj> objs) {
        this.title = title;
        this.active = active;
        this.count = count;
        this.tags = tags;
    ...
    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code LegacyMyComplexObj}.
     * @return the meta-bean, not null
     */
    public static LegacyMyComplexObj.Meta meta() {
        return LegacyMyComplexObj.Meta.INSTANCE;
    }

    static {
        MetaBean.register(LegacyMyComplexObj.Meta.INSTANCE);
    }

    @Override
    public LegacyMyComplexObj.Meta metaBean() {
        return LegacyMyComplexObj.Meta.INSTANCE;
    }
     ...
     * @return the value of the property
     */
    public LegacyMyNestedObj getNested() {
        return nested;
    }
     ...
     * @return the property, not null
     */
    public final Property<LegacyMyNestedObj> nested() {
     ...
     * @return the value of the property
     */
    public List<LegacyMyListComplexObj> getObjs() {
        return objs;
    }
     ...
     * @return the property, not null
     */
    public final Property<List<LegacyMyListComplexObj>> objs() {
        return metaBean().objs().createProperty(this);
    }

    //-----------------------------------------------------------------------
    @Override
    public LegacyMyComplexObj clone() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            LegacyMyComplexObj other = (LegacyMyComplexObj) obj;
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<List<String>> tags = DirectMetaProperty.ofReadOnly(
                this, "tags", LegacyMyComplexObj.class, (Class) List.class);
        /**
         * The meta-property for the {@code nested} property.
         */
        private final MetaProperty<LegacyMyNestedObj> nested = DirectMetaProperty.ofReadOnly(
                this, "nested", LegacyMyComplexObj.class, LegacyMyNestedObj.class);
        /**
         * The meta-property for the {@code objs} property.
         */
        @SuppressWarnings({"unchecked", "rawtypes" })
        private final MetaProperty<List<LegacyMyListComplexObj>> objs = DirectMetaProperty.ofReadOnly(
                this, "objs", LegacyMyComplexObj.class, (Class) List.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends LegacyMyComplexObj> builder() {
            return new DirectBeanBuilder<>(new LegacyMyComplexObj());
        }

        @Override
        public Class<? extends LegacyMyComplexObj> beanType() {
            return LegacyMyComplexObj.class;
        }
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<LegacyMyNestedObj> nested() {
            return nested;
        }
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<List<LegacyMyListComplexObj>> objs() {
            return objs;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 110371416:  // title
                    return ((LegacyMyComplexObj) bean).getTitle();
                case -1422950650:  // active
                    return ((LegacyMyComplexObj) bean).isActive();
                case 94851343:  // count
                    return ((LegacyMyComplexObj) bean).getCount();
                case 3552281:  // tags
                    return ((LegacyMyComplexObj) bean).getTags();
                case -1048944393:  // nested
                    return ((LegacyMyComplexObj) bean).getNested();
                case 3404380:  // objs
                    return ((LegacyMyComplexObj) bean).getObjs();
            }
