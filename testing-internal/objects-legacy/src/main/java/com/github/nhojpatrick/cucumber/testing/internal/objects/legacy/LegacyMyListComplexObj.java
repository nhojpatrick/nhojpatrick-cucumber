...
@JsonPropertyOrder({
        LegacyMyListComplexObj.LC_BOTTOM,
        LegacyMyListComplexObj.LC_ID,
        LegacyMyListComplexObj.LC_NAME
})
@SuppressFBWarnings(value = "CN_IDIOM_NO_SUPER_CALL", justification = "Managed by JodaBeans")
@SuppressWarnings("PMD.UselessParentheses")
public class LegacyMyListComplexObj
        implements Bean,
        Cloneable {
    ...
    @PropertyDefinition(set = "")
    private final LegacyMyListComplexBottomObj lcBottom;

    LegacyMyListComplexObj() {
        this.lcName = null;
        this.lcId = 0;
        this.lcBottom = null;
    }

    public LegacyMyListComplexObj(final String lcName,
                                  final int lcId,
                                  final LegacyMyListComplexBottomObj lcBottom) {
        this.lcName = lcName;
        this.lcId = lcId;
    ...
    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code LegacyMyListComplexObj}.
     * @return the meta-bean, not null
     */
    public static LegacyMyListComplexObj.Meta meta() {
        return LegacyMyListComplexObj.Meta.INSTANCE;
    }

    static {
        MetaBean.register(LegacyMyListComplexObj.Meta.INSTANCE);
    }

    @Override
    public LegacyMyListComplexObj.Meta metaBean() {
        return LegacyMyListComplexObj.Meta.INSTANCE;
    }
     ...
     * @return the value of the property
     */
    public LegacyMyListComplexBottomObj getLcBottom() {
        return lcBottom;
    }
     ...
     * @return the property, not null
     */
    public final Property<LegacyMyListComplexBottomObj> lcBottom() {
        return metaBean().lcBottom().createProperty(this);
    }

    //-----------------------------------------------------------------------
    @Override
    public LegacyMyListComplexObj clone() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            LegacyMyListComplexObj other = (LegacyMyListComplexObj) obj;
    ...
    public String toString() {
        ...
        buf.append("LegacyMyListComplexObj{");
        int len = buf.length();
        toString(buf);
        if (buf.length() > len) {
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<String> lcName = DirectMetaProperty.ofReadOnly(
                this, "lcName", LegacyMyListComplexObj.class, String.class);
        /**
         * The meta-property for the {@code lcId} property.
         */
        private final MetaProperty<Integer> lcId = DirectMetaProperty.ofReadOnly(
                this, "lcId", LegacyMyListComplexObj.class, Integer.TYPE);
        /**
         * The meta-property for the {@code lcBottom} property.
         */
        private final MetaProperty<LegacyMyListComplexBottomObj> lcBottom = DirectMetaProperty.ofReadOnly(
                this, "lcBottom", LegacyMyListComplexObj.class,
                LegacyMyListComplexBottomObj.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends LegacyMyListComplexObj> builder() {
            return new DirectBeanBuilder<>(new LegacyMyListComplexObj());
        }

        @Override
        public Class<? extends LegacyMyListComplexObj> beanType() {
            return LegacyMyListComplexObj.class;
        }
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<LegacyMyListComplexBottomObj> lcBottom() {
            return lcBottom;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case -1109170014:  // lcName
                    return ((LegacyMyListComplexObj) bean).getLcName();
                case 3314930:  // lcId
                    return ((LegacyMyListComplexObj) bean).getLcId();
                case -1090888062:  // lcBottom
                    return ((LegacyMyListComplexObj) bean).getLcBottom();
            }
