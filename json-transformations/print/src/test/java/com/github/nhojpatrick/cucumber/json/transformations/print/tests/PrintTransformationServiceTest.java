...
import com.github.nhojpatrick.cucumber.json.transformations.print.PrintTransformationService;
...
public class PrintTransformationServiceTest {
    ...
    class basic {
        ...
        private PrintTransformation classUnderTest;
    ...
    private PrintTransformationService classUnderTest;

    @BeforeEach
    public void beforeEach() {
        this.classUnderTest = new PrintTransformationService();
    }
    ...
    public void getAction() {
        ...
        assertThat("Unexpected Action", result, is(equalTo(PrintTransformationService.ACTION)));
    }
    ...
    public Collection<DynamicTest> resolve() {
        ...
        return Arrays.asList(
                ...
                dynamicTest("empty TransformActionTask", () -> {
                    ...
                    assertThat(actual, is(equalTo(new PrintTransformation())));
                })
