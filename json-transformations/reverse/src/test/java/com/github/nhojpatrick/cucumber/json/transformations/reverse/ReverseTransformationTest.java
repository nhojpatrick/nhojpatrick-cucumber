...
public class ReverseTransformationTest {
    ...
    @TestFactory
    public Collection<DynamicTest> successReverse() {
...
//                    );
                ...
                DynamicTest.dynamicTest("path key keyBooleanArray", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(false, true, false, true)));
                ...
                DynamicTest.dynamicTest("path key keyDoubleArray", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(45.67d, 34.56d, 23.45d, 12.34d)));
                ...
                DynamicTest.dynamicTest("path key keyFloatArray", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(45.67f, 34.56f, 23.45f, 12.34f)));
                ...
                DynamicTest.dynamicTest("path key keyIntegerArray", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(4567, 3456, 2345, 1234)));
                ...
                DynamicTest.dynamicTest("path key keyLongArray", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(4567L, 3456L, 2345L, 1234L)));
                ...
                DynamicTest.dynamicTest("path key keyMap", () -> {
                    ...
                    final Executable testMethod = () -> classUnderTest.perform(new PathElementImpl(key), input, "currentPath.keyMap");
                ...
                DynamicTest.dynamicTest("path key keyStringArray", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList("dString", "cString", "bString", "aString")));
    ...
    public Collection<DynamicTest> successList() {
        ...
        return Arrays.asList(
                ...
                DynamicTest.dynamicTest("path key keyArray[1]", () -> {
                    ...
                    final PathArrayElementImpl pathElement = new PathArrayElementImpl(String.format("%s[%s]", key, arrayIndex), key, arrayIndex);
                    final Executable testMethod = () -> classUnderTest.perform(pathElement, input, "currentPath");
                    final IllegalPathOperationException thrown = assertThrows(IllegalPathOperationException.class, testMethod);
                    assertAll("Checking Exception",
                ...
                DynamicTest.dynamicTest("path key keyBooleanArray[1]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(true, "eslaf", true, false)));
                ...
                DynamicTest.dynamicTest("path key keyBooleanArray[5]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(true, false, true, false, null, null)));
                ...
                DynamicTest.dynamicTest("path key keyDoubleArray[1]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(12.34d, "54.32", 34.56d, 45.67d)));
                ...
                DynamicTest.dynamicTest("path key keyDoubleArray[5]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(12.34d, 23.45d, 34.56d, 45.67d, null, null)));
                ...
                DynamicTest.dynamicTest("path key keyFloatArray[1]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(12.34f, "54.32", 34.56f, 45.67f)));
                ...
                DynamicTest.dynamicTest("path key keyFloatArray[5]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(12.34f, 23.45f, 34.56f, 45.67f, null, null)));
                ...
                DynamicTest.dynamicTest("path key keyIntegerArray[1]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(1234, "5432", 3456, 4567)));
                ...
                DynamicTest.dynamicTest("path key keyIntegerArray[5]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(1234, 2345, 3456, 4567, null, null)));
                ...
                DynamicTest.dynamicTest("path key keyLongArray[1]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(1234L, "5432", 3456L, 4567L)));
                ...
                DynamicTest.dynamicTest("path key keyLongArray[5]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList(1234L, 2345L, 3456L, 4567L, null, null)));
                ...
                DynamicTest.dynamicTest("path key keyMapArray[1]", () -> {
                    ...
                    final PathArrayElementImpl pathElement = new PathArrayElementImpl(String.format("%s[%s]", key, arrayIndex), key, arrayIndex);
                    final Executable testMethod = () -> classUnderTest.perform(pathElement, input, "currentPath.keyMapArray[1]");
                    final IllegalPathOperationException thrown = assertThrows(IllegalPathOperationException.class, testMethod);
                    assertAll("Checking Exception",
                ...
                DynamicTest.dynamicTest("path key keyStringArray[1]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList("aString", "gnirtSb", "cString", "dString")));
                ...
                DynamicTest.dynamicTest("path key keyStringArray[5]", () -> {
                    ...
                    final Map<String, Object> expected = new HashMap<>(getBasicJsonMap());
                    expected.put(key, new ArrayList<>(Arrays.asList("aString", "bString", "cString", "dString", null, null)));
