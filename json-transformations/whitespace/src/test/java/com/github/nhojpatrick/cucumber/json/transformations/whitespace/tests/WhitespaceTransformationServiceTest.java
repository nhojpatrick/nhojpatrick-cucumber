...
import com.github.nhojpatrick.cucumber.json.transformations.whitespace.WhitespaceTransformationService;
...
public class WhitespaceTransformationServiceTest {
    ...
    class basic {
        ...
        public void beforeEach()
            ...
            this.classUnderTest = new WhitespaceTransformation(1, 1);
        }
        ...
        public void toStringTest() {
            ...
            assertAll("toString",
                    () -> assertThat("should match", this.classUnderTest, is(toStringGenerated("WhitespaceTransformation[1,1]"))),
    ...
    private WhitespaceTransformationService classUnderTest;

    @BeforeEach
    public void beforeEach() {
        this.classUnderTest = new WhitespaceTransformationService();
    }
    ...
    public void getAction() {
        ...
        assertThat("Unexpected Action", result, is(equalTo(WhitespaceTransformationService.ACTION)));
    }
