open module com.github.nhojpatrick.cucumber.json.transformations.whitespace.test {
    uses com.github.nhojpatrick.cucumber.json.core.transform.TransformationService;
    requires com.github.nhojpatrick.cucumber.json.transformations.whitespace;
